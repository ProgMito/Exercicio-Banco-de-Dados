...
/* mostra todas as linhas da tabela sexo sem repetir */
...
/*ou from funcionario as f, dependente d ("as" indica o apelido dado ao nome da coluna)*/

/* mostra todas as linhas da tabela sexo com as repetições */
select sexo
from funcionario;

select funcionario.sexo
from funcionario, dependente;


/* Exercícios Álgebra Relacional e SQL: Seleção */
...
select *
from dependente
where parentesco = "esposa" or parentesco = "filha" or parentesco = "filho";
